  ...
  <div className={styles.nav}> 
    <ul className={styles.centered}>
        <li className={styles.navLink}>
            <Link href="/brands?q=top=brands">Top Sellers</Link>
        </li>
        <li className={styles.navLink}>
            <Link href="/products">Upcoming Brands</Link>
        </li>
        <li className={styles.navLink}>
            <Link href="/products">Favorite Brands</Link>
        </li>
        <li className={styles.navLink}>
            <Link href="/products">Top Rated</Link>
        </li>
    </ul>
  </div>

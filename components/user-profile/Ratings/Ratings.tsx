...
import Child1 from "./RatingsDropdown";
            ...
            <div className={styles.card}>
                <div className={styles.row}>
                    ...
                    <div className={styles.columnright}>
                        ...
                        <button onClick={() => this.hideComponent("shchild1")} className={styles.buttonExpand}>
                            Rate this product
                        </button>
                    </div>
                </div>

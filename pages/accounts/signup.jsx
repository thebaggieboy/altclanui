...
export default function SignUp() {
	...
	//const { isIdle, isPending, error, mutateAsync: signUpFn } = useDjoserSignup("https://altclan-api.onrender.com/auth/jwt/create", signUpSuccess, USER_TYPES.user)
	...
	const submit = async (e) => {
		...
		try {
			...
			const res = await fetch(url, {
                ...
                body: JSON.stringify({ email:email, password:password1, first_name:'', last_name:'', mobile_number:'', display_picture:null}),
                credentials: "include"

...
<section class="bg-white p-5 dark:bg-gray-900" style={{lineHeight:'100%', letterSpacing:3, fontFamily:'Poppins, Sans-serif'}}>
  <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 px-4">
      ...
      <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
          <a href={deleteUser(`https://altclan-api-v1.onrender.com/api/users/${user?.id}`)} class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-red-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
              Yes, i'm sure

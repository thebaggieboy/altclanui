...
<form className="flex items-center">   
    ...
    <button type="submit" className="p-2.5 ml-2 text-sm font-medium text-dark bg-black rounded-lg border border-black hover:bg-white focus:ring-4 focus:outline-none focus:ring-black">

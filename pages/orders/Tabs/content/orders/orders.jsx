...
const orders = [
  { id: '#875690', productName: 'Nike Air Julia', date: '02, May 2025', paymentMethod: 'Card', qty: 1, status: 'Completed', amount: '150,697' },
  { id: '#875691', productName: 'Tennis Chain', date: '03, May 2025', paymentMethod: 'Paystack', qty: 2, status: 'Pending', amount: '84,345' },
  { id: '#875690', productName: 'Gold Nose Cuff', date: '04, May 2025', paymentMethod: 'PayPal', qty: 3, status: 'Cancelled', amount: '3,234' },
];
      ...
      {selectedOrder && (
        <>
          ...
          <div className={styles.popup}>
            ...
            <p><strong>Payment method used:</strong> {selectedOrder.paymentMethod}</p>

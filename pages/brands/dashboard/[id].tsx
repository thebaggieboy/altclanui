...
const Dashboard = ({id, brand}) => {
  ...
  const totalRevenue = async() =>{
    ...
    const revenueUrl =  await fetch(`https://altclan-brands-api.onrender.com/api/brand_dashboard/${user?.id}`)
		const revenueData =  await revenueUrl.json()
 ...
 const totalProfit = () =>{
  ...
  return (
    ...
    <>
  <h1 className="mt-5 p-2 bolder text-center" style={{fontFamily:'Poppins, Sans-serif', fontSize:30, fontWeight:"bolder"}}>Welcome Altclan</h1>
      <div className="mt-4 p-4 grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        ...
        <CardDataStats title="Views" total="0" rate="0.00%" levelUp>
          <svg
            className="fill-primary dark:fill-white"
            width="20"
            height="22"
        ...
        <CardDataStats title="Customers" total="0" rate="0.00" levelDown>
          <svg
            className="fill-primary dark:fill-white"
            width="22"
            height="18"

...
export default function Blog() {
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div class="mx-auto p-3 max-w-screen-sm text-center lg:mb-16 mb-8">
          ...
          <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">We use an agile approach to test assumptions and connect with the needs of your audience early and often.</p> <br />
          {user ? <button style={{backgroundColor:'black', color:'white', padding:10}}>Write articcle</button> : <a href='/brands/login' style={{backgroundColor:'black', color:'white', padding:20}}>Login to create new article</a>}
      </div> 
      <div class="grid gap-8 lg:grid-cols-2">
          <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
              ...
              <div class="flex justify-between items-center">
                  ...
                  <a href="/blog/detail/1/" class="inline-flex items-center font-medium text-primary-600 dark:text-primary-500 hover:underline">
                      Read more

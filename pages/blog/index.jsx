...
export default function Blog() {
  ...
  <div class="px-4 mx-auto max-w-screen-xl lg:py-2 lg:px-6">
      <div class="mx-auto p-1 max-w-screen-sm text-center lg:mb-16 mb-8">
          <h2 class="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Our Blog</h2>
          <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">We use an agile approach to test assumptions and connect with the needs of our audience early and often.</p> <br /> <br />
      ...
      {data.map((article)=>(
       ...
       <p class="mb-5 font-light text-gray-500 dark:text-gray-400">{article.text}</p>
